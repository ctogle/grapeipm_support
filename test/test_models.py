...
class test_idata(unittest.TestCase):
    ...
    def test_botrytis(self):
        cf = botrytis.botrytis.botrytis.classifyindex
    ...
    def test_black_rot(self):
        cf = black_rot.black_rot.black_rot.classifyindex
...
if __name__ == '__main__':
    ...
    sys.path.insert(0,p)
    botrytis = __import__('models.botrytis')
    black_rot = __import__('models.black_rot')
    sys.path.pop(0)
    unittest.main()
