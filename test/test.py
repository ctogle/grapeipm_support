...
class test_idata(unittest.TestCase):
	...
	def test_SPAREC(self):
		...
		pointchecks = (
			(12699,(
				...
				'2014-10-01 00:00:00,12699,NULL,16.9258,99.998,434.8222,0,0,15,NULL,15,SPAREC_canopy',
				)),
				)
	...
	def test_Gadino(self):
		...
		pointchecks = (
			(90051,(
				...
				'2017-01-24 12:15:00,90051,NULL,15.13467,65.253,271.6607,15,0,0,NULL,15,Gadino_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_AHSPP(self):
		...
		pointchecks = (
			(12508,(
				...
				'2014-10-01 00:00:00,12508,NULL,15.56787,99.998,306.1296,0,0,15,NULL,15,AHSPP_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_AHSGPCH(self):
		...
		pointchecks = (
			(12611,(
				...
				'2014-10-01 00:00:00,12611,NULL,15.20867,99.998,290.9353,0,0,15,NULL,15,AHSGP-CH_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_AHSGPO(self):
		...
		pointchecks = (
			(12602,(
				...
				'2014-10-01 00:00:00,12602,NULL,15.28613,99.998,350.9913,0,0,15,NULL,15,AHSGP-O_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_SC2High(self):
		...
		pointchecks = (
			(11368,(
				...
				'2014-10-01 00:00:00,11368,NULL,16.99967,98.105,276.8419,NULL,NULL,0,NULL,15,SC2-High_canopy',
				'2014-10-01 00:00:00,11368,NULL,16.7028,99.998,276.9864,NULL,NULL,0,NULL,15,SC2-High_apple_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_SC3Low(self):
		...
		pointchecks = (
			(11366,(
				...
				'2014-10-01 00:00:00,11366,NULL,17.86253,98.996,277.2244,NULL,NULL,0,NULL,15,SC3-Low_canopy',
				'2014-10-01 00:00:00,11366,NULL,18.10533,98.598,276.4847,NULL,NULL,0,NULL,15,SC3-Low_apple_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_Ingleside(self):
		...
		pointchecks = (
			(78018,(
				...
				'2015-10-01 00:00:00,78018,NULL,18.881,92.195,275.6361,0,15,0,NULL,15,Ingleside_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_SC1MiddleBase(self):
		...
		pointchecks = (
			(12238,(
				...
				'2014-10-01 00:00:00,12238,NULL,17.45,99.8,278,NULL,NULL,0,NULL,15,SC1-MiddleBase_canopy',
				'2014-10-01 00:00:00,12238,NULL,17.68,99,275.3,NULL,NULL,0,NULL,15,SC1-MiddleBase_apple_canopy',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_CR200Barboursville(self):
		...
		hydrocodes = ('CR200@Barboursville_air',)
		nulls = ((4,5,6,7,8,9),)
		...
		pointchecks = (
			(14910,(
				'2017-01-01 00:00:00,14910,13.22355,'+str(5.0*(42.36921-32.0)/9.0)+',NULL,NULL,NULL,NULL,NULL,NULL,60,CR200@Barboursville_air',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
	...
	def test_CR800Barboursville(self):
		...
		start,end = '2016-12-31 23:59:59','2017-10-05 00:00:00'
		hydrocodes = ('CR800@Barboursville_air',)
		nulls = ((),)
		...
		pointchecks = (
			(10250,(
				'2017-01-01 00:00:00,10250,11.5,'+str(5.0*(41.74-32.0)/9.0)+',47.27,-987,60,0,0,'+str(25.4*0)+',60,CR800@Barboursville_air',
				)),
				)
		self.check_rowcount_rowlength_hydrocode_interval_nulls_records(
			ifile,start,end,rowlength,hydrocodes,records,nulls,interval,datapoints,pointchecks)
